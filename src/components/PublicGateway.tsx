...
const destinations: readonly Destination[] = [
  ...
  },
  {
    ...
    title: "F.R.A.M.",
    definition: "言葉で構想し、AIエージェントと開発する世界記憶型・放浪ローグライク",
    description:
      "自然に侵食された現代都市を放浪し、遺物を回収しながら、その遠征で得た素材でビルドを組み替えるローグライク。遠征と帰還を繰り返し、選択の結果や持ち帰ったものが次のランに残る。ゲーム本体と、世界・人物・遺物を共通のルールから組み立てる仕組みを、言葉で設計し、AIエージェントによる実装と人の試遊・採否を繰り返しながら開発している。",
